...
import bonus.shared.generated.resources.menu_back
...
import bonus.shared.generated.resources.player_names_title
...
fun SettingsScreen(store: PlayerNamesStore, onBack: () -> Unit) {
    ...
    val defaultA = stringResource(Res.string.player_a_default)
    val defaultB = stringResource(Res.string.player_b_default)
    ...
    NoiseBackground {
        Column(modifier = Modifier.fillMaxSize().padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(stringResource(Res.string.player_names_title), modifier = Modifier.padding(top = 16.dp))
            OutlinedTextField(
                value = nameA,
                ...
                modifier = Modifier.width(240.dp).padding(top = 12.dp).background(Color.White, RoundedCornerShape(4.dp)),
            ...
            OutlinedTextField(
                ...
                modifier = Modifier.width(240.dp).padding(top = 12.dp).focusRequester(focusRequesterB).background(Color.White, RoundedCornerShape(4.dp)),
                colors = OutlinedTextFieldDefaults.colors(unfocusedContainerColor = Color.White, focusedContainerColor = Color.White),
            )
            BevelButton(text = stringResource(Res.string.menu_back), onClick = { save(); onBack() }, modifier = Modifier.padding(top = 24.dp))
        }
    }
}
